...
<form id="orderForm" class="hide" action="/order/create.html" method="post">
		...
		<input type="hidden" name="orderShipping.receiverName" value="小旋"/>
		<input type="hidden" name="orderShipping.receiverMobile" value="13613666666"/>
		...
		<input type="hidden" name="orderShipping.receiverAddress" value="故宫xxxxx号"/>
</form>
   			...
   			<ul class="ui-switchable-panel-main" id="consignee-list">
				...
				<li class="ui-switchable-panel" id="consignee_index_137617472"
					...
					<div class="consignee-item item-selected"
						...
						<div class="user-name">
							<div class="fl">
								<strong limit="4">小旋</strong>&nbsp;&nbsp;收
							</div>
							<div class="fr">136****6666</div>
							<div class="clr"></div>
						</div>
